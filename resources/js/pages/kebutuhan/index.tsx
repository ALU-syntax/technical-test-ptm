...
const breadcrumbs: BreadcrumbItem[] = [
  ...
  { title: "Kebutuhan", href: "/kebutuhan" },
];

const moduleName = "Kebutuhan";
const moduleTitle = "Manajemen Kebutuhan";
const moduleSubTitle = "Kelola Kebutuhan dan datanya";
...
export default function Index({ items, filters, createUrl, listCategoryKebutuhan }: Props) {
  ...
  return (
    <AppLayout breadcrumbs={breadcrumbs}>
                  ...
                  {items.data.length === 0 ? (
                    ...
                    items.data.map((item) => (
                      <TableRow key={item.id}>
                        ...
                        <TableCell className="font-medium">{item.category_kebutuhan_name}</TableCell>
                        <TableCell>
      ...
      <FormModal
        ...
        mode="create"
        submitUrl={createUrl}
        listCategoryKebutuhan={listCategoryKebutuhan}
      />
